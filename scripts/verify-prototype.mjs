...
const checks={policyLoaded:!!policy,split2Coverage:policy?Object.keys(policy.split2).length===12168:false,fillCoverage:policy?Object.keys(policy.fill).length>0:false,build:fs.existsSync('dist/index.html'),smoke:smoke?.smoke_matches===100,fuzz:smoke?.fuzz_sequences>=30};
